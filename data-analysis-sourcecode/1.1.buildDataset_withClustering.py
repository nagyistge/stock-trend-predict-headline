...
Usage: 
   python 1.1.buildDataset_withClustering.py sem_space n_threads dataset_vector_f dataset_label_f dataset_stock_f
E.g from command line: 
"python 1.1.buildDataset_withClustering.py ../spaces/heads.pkl 4 dataset.vectors dataset.labels dataset.stocks"
    
Parameters:
    - sem_space: the semantic space
    - n_threas: number of threads to run
    - [OUT] dataset_vector_f: name of the dataset vector file
    - [OUT] dataset_label_f: name of the dataset label file
...
if __name__ == '__main__':
    ...
    while (current_time < datetime.now() and time_out_count < 336):
