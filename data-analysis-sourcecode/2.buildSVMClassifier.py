...
Usage: 
python 2.buildSVMClassifier.py dataset.vectors dataset.labels report.csv
python 2.buildSVMClassifier.py testset.maxmean.cos.vectors testset.labels maxmean_report.csv
python 2.buildSVMClassifier.py testset.sumsum.cos.vectors testset.labels sumsum_report.csv
...
if __name__ == '__main__':
    ...
    scoring_estimators = ['accuracy','f1','precision','recall','roc_auc'];    
